...
public class ChessBoard {
    ...
    public void resetBoard() {
        ...
        for (int i = 1; i < 9; i++) {
            ...
            ChessPiece pawnb;
            pawnb = new ChessPiece(ChessGame.TeamColor.WHITE, ChessPiece.PieceType.PAWN);
        ...
        for (int i = 1; i < 9; i++) {
            ...
            ChessPiece pawnw;
            pawnw = new ChessPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN);
